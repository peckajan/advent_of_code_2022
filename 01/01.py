...
FILE_PATH = r'C:\Users\janpe\Documents\FIT\ZIVS\advent\01\input.txt'

# Nacte soubor a vsechny radky z nej
def readFile(file):
...
# Secte jednotlive elfy a da je do pole
def getElfs(lines):
...
# Vypise elfa s nejvetsim skore a pak soucet trech nejlepsich
def getBestElf():
    ...
    print("max elf", elfs[0], "top 3", topThree)
